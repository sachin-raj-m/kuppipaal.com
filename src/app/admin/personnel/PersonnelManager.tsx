      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="p-6 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
          <div className="flex items-center gap-2 text-slate-700">
            ...
            <span className="font-semibold">{personnel.length} Personnel Registered</span>
          </div>
          {!isFormOpen && (
            <button
        ...
        {isFormOpen && (
          <div className="p-6 border-b border-slate-200 bg-blue-50/30">
            <h3 className="font-semibold text-slate-800 mb-4">New Delivery Personnel</h3>
            <form onSubmit={handleCreate} className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-3 flex justify-end gap-2 pt-2">
                <button
                  ...
                  className="bg-white border border-slate-300 text-slate-700 px-4 py-2 rounded-md hover:bg-slate-50 text-sm font-medium transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 text-sm font-medium transition-colors disabled:opacity-60"
                >
